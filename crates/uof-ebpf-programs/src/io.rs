...
#[tracepoint]
pub fn handle_block_rq_insert(_ctx: TracePointContext) -> u32 {
...
#[tracepoint]
pub fn handle_block_rq_complete(_ctx: TracePointContext) -> u32 {
...
#[tracepoint]
pub fn handle_block_rq_issue(_ctx: TracePointContext) -> u32 {
